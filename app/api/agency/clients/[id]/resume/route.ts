 ...
 * 
 * Resume a paused client (adds back to billing)
 */
  ...
  try {
    ...
    if (agency.stripeSubscriptionId) {
      try {
        ...
        console.error('[agency/clients/resume] Failed to update Stripe quantity:', error)
      }
    }
    ...
    console.error('[api/agency/clients/resume] Error:', error)
    return NextResponse.json(
